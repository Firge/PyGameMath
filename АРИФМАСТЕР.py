...
class Menu:
    ...
    %
        ...
        self.rect_opt = pg.Rect(1030, 540, 91, 93)
        ...
        self.but_table = pg.transform.scale(self.but_table,
                                            [int(self.but_table.get_width() * 0.8),
                                             int(self.but_table.get_height() * 0.8)])
        ...
        while start:
            ...
            for event in pg.event.get():
                ...
                if self.MENU and event.type == pg.MOUSEBUTTONDOWN:
                    x, y = event.pos
                    if self.MENU:
                        if 250 <= x <= 250 + self.button_block.get_width():
                        ...
                        if 965 <= x <= 965 + self.but_table.get_width():
                            if 130 <= y <= 130 + self.but_table.get_height():
            ...
            if self.MENU:
                ...
                font = pg.font.Font(".data/Menu/font/norm.ttf", 30)
