...
class GPushButton(pygame.sprite.Sprite):
    ...
    def hover_AnimationOfText(self, text: str = None, textColor: tuple = None, fontName: str = None,
                              fontSize: int = None, textPosition: str = None, active: bool = True):
    ...
    def hover_AnimationChangeSize(self, deltawidth: int = 0, deltaheight: int = 0,
                                  measure: str = "px", active: bool = True):
    ...
    def hover_reaction(self, active):
        ...
        if active:
            ...
            if self.AnimationMotion:
                ...
                self.hitbox = pygame.transform.scale(self.hitbox, (
                self.width + self.xmotion, self.height + self.ymotion))
